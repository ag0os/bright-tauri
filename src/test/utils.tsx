...
/**
 * Create a mock StorySummary object for list endpoint testing
 */
export function createMockStorySummary(overrides: Partial<StorySummary> = {}): StorySummary {
  return {
    id: 'story-1',
    universeId: 'universe-1',
    title: 'Test Story',
...
/**
 * Create a mock StoryDetail object for get_story endpoint testing
 */
