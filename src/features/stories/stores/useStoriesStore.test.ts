...
describe('useStoriesStore - Filter and Sort Functionality', () => {
  ...
  const createMockStory = (overrides: Partial<StorySummary> = {}): StorySummary => ({
    id: 'story-1',
  ...
  describe('Search Functionality', () => {
    ...
    it('searches across title and description', () => {
      const stories: StorySummary[] = [
        createMockStory({ id: 's1', title: 'Dragon Story', description: 'About wizards' }),
        createMockStory({ id: 's2', title: 'Wizard Tale', description: 'About knights' }),
        createMockStory({ id: 's3', title: 'Knight Story', description: 'About dragons' }),
      ];
    ...
    it('does not match stories when search term is only in other fields', () => {
      const stories: StorySummary[] = [
        createMockStory({ id: 's1', title: 'Story 1', description: 'No match here' }),
        createMockStory({ id: 's2', title: 'Story 2', description: 'Contains search term' }),
      ];
