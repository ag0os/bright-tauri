...
description: Manage project tasks using the backlog.md CLI tool. Use when working with tasks, creating tasks, editing tasks, marking acceptance criteria, checking task status, or any task management workflow. Triggers on mentions of "backlog", "task", "tasks", "acceptance criteria", "AC", "implementation plan", or task IDs like "task-42".
